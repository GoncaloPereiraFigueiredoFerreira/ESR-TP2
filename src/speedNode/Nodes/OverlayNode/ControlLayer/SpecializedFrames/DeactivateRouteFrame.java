...
public class DeactivateRouteFrame extends BaseFrame{
    public static int priority = 1;

    public DeactivateRouteFrame(String neighbourName, long timestamp) {
        super(neighbourName, timestamp);
    }

    public DeactivateRouteFrame(String neighbourName){
    ...
    public static BaseFrame deserialize(String neighbourName, Frame frame) {
        ...
        try {
            ...
            in.close();
            bais.close();
            return new DeactivateRouteFrame(neighbourName, timestamp) ;
    ...
    public Frame serialize() {
        ...
        return new Frame(0, Tags.DEACTIVATE_ROUTE, data);
    }
}
