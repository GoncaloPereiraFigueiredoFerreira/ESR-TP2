...
public class Bootstrap implements Runnable{
    ...
    public Bootstrap(String Bootstrap_config_filename) throws Exception {
        sharedInfo = new BootstrapSharedInfo(readConfigFile_antigo(Bootstrap_config_filename));
    }
    ...
    public static Map<String, List<String>> readConfigFile_antigo(String filename) throws Exception {
